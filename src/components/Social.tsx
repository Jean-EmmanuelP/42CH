...
export default function Social() {
  ...
  return (
    <div className="flex h-full w-full flex-col  rounded-r-md bg-white shadow-md">
      <div className="h-[15%]">
        <p className="w-full pt-2 font-bold">Social</p>
        {/* Start of Card of a player */}
        ...
        {/* End of Card of a player */}
      </div>
      <div className="h-[30%] w-full border-b border-black">
        <p className="pl-4 pt-2 font-bold">Amis</p>
        <div className="flex flex-col gap-1 h-[83%] overflow-y-auto no-scrollbar">
          <div className="flex w-full items-center border-y border-black shadow-sm">
            <img
              src="https://cdn.intra.42.fr/users/360e47329956d8a4293e03f4113107d2/lgillard.jpg"
              alt="questionMark"
