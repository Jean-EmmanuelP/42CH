...
export default function Social() {
  ...
  async function getUserProfile() {
    const request = await axios.post(publicRuntimeConfig.NEXT_PUBLIC_API_URL+"/user/get_user_infos/", JSON.stringify({ username: sessionStorage.getItem('username') }), { headers: { 'Content-Type': 'application/json' } })
  ...
  async function getFriends() {
    const request = await axios.post(publicRuntimeConfig.NEXT_PUBLIC_API_URL+"/user/get_friends/", JSON.stringify({ username: sessionStorage.getItem('username') }), { headers: { 'Content-Type': 'application/json' } })
  ...
  async function getOnlineUsers() {
    const request = await axios.get(publicRuntimeConfig.NEXT_PUBLIC_API_URL+"/user/get_online_users/")
