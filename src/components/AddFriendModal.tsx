    ...
    <div className="relative flex h-[20vh] w-full flex-col items-center justify-center bg-[#EEF0F3]">
      ...
      <div className='mt-4 h-[30%] flex items-center justify-center'>
        <button
          ...
          onClick={async () => {
            const request = await axios.post(process.env.NEXT_PUBLIC_API_URL + "/user/add_friend/", JSON.stringify({ username: sessionStorage.getItem("username"), friendUsername: username }), { headers: { 'Content-Type': 'application/json' } })
